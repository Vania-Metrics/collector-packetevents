// colecteur-packetevents — a VaniaMetrics-<Name>-<v>.jar in build/libs/
//
...
// The jar name comes from "name:", not the entry-point class: the server
// repo's list refers to modules by their plugin name. A single source, the
// one Bukkit displays.
